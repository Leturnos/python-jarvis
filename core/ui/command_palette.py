...
class CommandPalette:
    ...
    def _create_ui(self):
        ...
        center_y = int(
            screen_height / 3 - window_height / 2
        ...
        search_entry = ttk.Entry(
            frame, textvariable=self.search_var, font=("Consolas", 14), width=50
        )
    ...
    def _on_search_change(self, *args):
        ...
        if not query:
            ...
            self.filtered_commands = [
                cmd for cmd in self.all_commands if query in cmd["label"].lower()
            ]
        self._update_listbox()
