...
from qfluentwidgets import SimpleCardWidget, TitleLabel, BodyLabel, ProgressBar
...
class StatusCardWidget(SimpleCardWidget):
    ...
    def update_from_snapshot(self, snapshot):
        ...
        state_colors = {
            "IDLE": "#00ff00", "LISTENING": "#ffff00", "THINKING": "#ff00ff",
            "CONFIRMING_DRY_RUN": "#0000ff", "EXECUTING": "#ff0000", 
            "MUTED": "#888888", "ERROR": "#ff5555"
        }
