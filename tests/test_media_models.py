from core.media.models import MediaAction, AutoplayStrategy, MediaIntent, QueryType, LastMediaContext, MediaSessionState
...
def test_last_media_context():
    ctx = LastMediaContext(provider="spotify", resolved_strategy="curated", playlist_key="happy_hits", raw_query="toca algo feliz")
